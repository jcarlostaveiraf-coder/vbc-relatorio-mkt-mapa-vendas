...
Envio: toda segunda 08h. Dados: acumulado do mês corrente até a data do envio.

Blocos do e-mail (topo, com visual):
  1. Mapa coroplético por UF
  2. Curva ABC de clientes (top 5 = quanto % do faturamento)
  3. Concentração regional (Sudeste x resto do Brasil)
  4. Evolução acumulada de vendas dia a dia no mês

Blocos do e-mail (rodapé, tabela compacta sem gráfico):
